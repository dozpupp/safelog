...
import { ArrowLeft, Shield, Loader2, Send, Lock, Users, UserPlus, UserMinus, Crown, ShieldCheck } from 'lucide-react';
    ...
    return (
        <div className="flex flex-1 flex-col bg-slate-50 dark:bg-slate-950 h-full">
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                {/* Members Panel */}
                {showMembers && (
                    <div className="w-64 border-l border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 overflow-y-auto">
                        <div className="p-3 border-b border-slate-200 dark:border-slate-800">
                            <h4 className="font-semibold text-sm text-slate-900 dark:text-white">Members ({members.length})</h4>
                        </div>
                        <div className="p-2 space-y-1">
                            {members.map(m => (
                                <div key={m.user_address} className="flex items-center gap-2 p-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
